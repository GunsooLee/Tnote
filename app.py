        ...
        if uploaded_file is not None:
            ...
            if st.button("파일 업로드"):
                ...
                # 회의제목이 입력되지 않았을 경우 경고 메시지 표시
                    ...
                    ['화자0', '우리가 인제 티랩을 같이 하게 됐는데, 주제를 이제 좀 정해야 될 것 같거든요.']
                    ...
                    ,['화자0', '근데 제 생각은 우리가 아직 주니어 레벨이니까 그냥 언어 그러니까 C언어라던지 자바라든지 이런 언어도 좀 공부해 보는 것도 나쁘지 않을 것 같아요.']
                    ,['화자3', '저는 좀 AI가 해보고 싶은데요. 요즘 AI가 대세잖아요, chatgpt든지 AI 해보면 좀 재미있을 것 같습니다.']
                    ,['화자0', '확실히 그 AI 관련해서 막 기사도 많이 올라오고 그런 것 같아요. AI 나쁘지 않은 것 같은데.']
                    ,['화자1', 'AI 좋은 것 같습니다.']
                    ,['화자0', '그쵸 AI 어때요?']
                    ,['화자2', 'AI를 한다. 그러면은 지금 아까 얘기한 것처럼 채 chatgpt도 있고 좀 분야가 많은 것 같은데.']
                    ,['화자2', 'AI에서 어떤 분야가 좀 더 해야 될지 이것조 이거를 좀 정해야 될 것 같습니다.']
                    ,['화자0', '그러면 아무래도 이게 우리가 회사에서 하는 거니까 업무에 좀 적용하기 좋은 주제를 잡고 하는 게 맞을 것 같은데요.']
                    ,['화자0', '우리 팀에서 사용하기 좋은 업무 주제가 있을까요? AI를 만약에 한다고 하면.']
                    ,['화자2', '제가 프로젝트 학교 다닐 때 썼던 게 이제 AI 쪽 챗봇을 한번 쓴 적이 있었거든요. 그래서 근데 그거는?']
                    ...
                    ,['화자0', '그.']
                    ,['화자0', '세포.']
                    ,['화자1', '챗봇은 그럼 우리 팀에서만 쓸 수 있는 걸 말하는 건가?']
                    ...
                    ,['화자0', '저는 나쁘지 않은 것 같아요. 그 주제']
                    ,['화자3', '네, 좋은 것 같아요. 회의록 요약.']
                    ]))
